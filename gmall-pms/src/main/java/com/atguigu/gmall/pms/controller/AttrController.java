...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttr(QueryCondition queryCondition,@RequestParam("cid")Long cid ,@RequestParam("type")Integer type){
        PageVo pageVo = attrService.queryPage(queryCondition, cid, type);
